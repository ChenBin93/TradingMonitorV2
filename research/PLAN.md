...
| c22 | 尾部收割因果重做（a38） | c13 部分 ❌（up:late 过、dn:late 4h 未达、top5% 度量为机械产物） | **暂缓**：待 c23/c21 结果后再定重做口径（若做：尾部特征须改用 C_share 类口径预注册，GBM≥30 种子+成本行） |

**Phase 2 执行序**：c23 + c21 并行 → c25 → （c22 视情况）。每项按 10 项门槛清单裁决。
