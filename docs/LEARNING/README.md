...
| 2 动量与振荡器 | CH9 | **✅ 完成（1 单元，2026-08-13）** |
| 3 时间与季节 | CH10-11 | **✅ 跳过考证（用户决定：加密无日历锚；归档理由见 module3/unit01）** |
| 4 成交量与持仓 | CH12 | **✅ 量部分完成（c49）；funding 待 3 个月以上数据** |
| 5 行为与形态 | CH14-15 | **✅ 完成（c54）** |
| 6 自适应技术 | CH17 | **✅ 完成（c27/c29/c50）** |
| 7 价格分布区带 | CH18 | **✅ 完成（c51/c52）** |
| 8 多时间框架 | CH19 | **✅ 完成（c55）** |
| 9 测试方法论与风险 | CH20-24 | **✅ 完成（c53，收官）** |
...
- 模块 7：`module7/unit01_price_distribution.md`（价格分布系统，✅ c51/c52）
- 模块 9：`module9/unit01_methodology.md`（验证、风险与组合，✅ c53，收官）
- 模块 3：`module3/unit01_seasonality_skipped.md`（季节性与周期，跳过考证）
- 模块 5：`module5/unit01_behavior_patterns.md`（行为与形态，✅ c54）
- 模块 8：`module8/unit01_multi_timeframe.md`（多时间框架，✅ c55）
